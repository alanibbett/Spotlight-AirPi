...
***Your raspberrypi should be set up before you get it but in case you want to build your own or need to rebuild the one you got follow these instructions.***
